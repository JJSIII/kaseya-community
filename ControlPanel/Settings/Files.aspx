<%@ Page language="c#" Codebehind="Files.aspx.cs" AutoEventWireup="false" Inherits="Telligent.Evolution.ControlPanel.Settings.FilesPage" MasterPageFile="~/ControlPanel/Masters/SetupAdmin.master" %>
<%@ Import Namespace = "Telligent.Evolution.Components" %>
<%@ Import Namespace = "Telligent.Evolution.ControlPanel" %>

<asp:Content ContentPlaceHolderId="DescriptionRegion" runat="server">
	<cp:resourcelabel id="title" runat="server" resourcename="CP_Settings_FileStorage_Title" />
</asp:Content>
...
<div class="CommonDescription">
	<CP:ResourceControl runat="server" ResourceName="CP_Settings_FileStorage_SubTitle" />
