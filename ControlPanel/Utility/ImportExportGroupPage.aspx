<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportExportGroupPage.aspx.cs" Inherits="Telligent.EvolutionWeb.ControlPanel.Settings.ImportExportGroupPage" MasterPageFile="~/ControlPanel/Masters/Modal.master" %>
	    ...
	    <div class="CommonContent">
	        <TWC:TabbedPanes runat="server"
                ...
                <TWC:TabbedPane runat="server">
	                ...
	                <Content>    
	                    <TEControl:ImportGroupThemeContentFragmentPageForm runat="server" FileHtmlInputFileId="File" ImportButtonId="Import" MessageTextId="Message" ScopedPropertyTextId="ScopedProperties">
                        ...
                        </TEControl:ImportGroupThemeContentFragmentPageForm>                    
	                </Content>
	            </TWC:TabbedPane>
	            <TWC:TabbedPane runat="server">
	                <Tab><CP:ResourceControl ResourceName="ImportExportPage_Export" runat="server" /></Tab>
	                <Content>
                        <TEControl:ExportGroupThemeContentFragmentPageForm runat="server" ExportButtonId="Export">
                            <FormTemplate>
                                <div class="CommonFormArea">
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                        ...
                        </TEControl:ExportGroupThemeContentFragmentPageForm>	                
	                </Content>
	            </TWC:TabbedPane>
	        </TWC:TabbedPanes>
        </div>
