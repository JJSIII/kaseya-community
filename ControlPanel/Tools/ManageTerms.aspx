<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="ManageTerms.aspx.cs" Inherits="Telligent.Evolution.ControlPanel.Tools.ManageTerms"  MasterPageFile="~/ControlPanel/Masters/SetupAdmin.master"  %>

<%@ Import Namespace="Telligent.Evolution.Components" %>

<asp:Content ID="Content1" ContentPlaceHolderId="DescriptionRegion" runat="server">
    <cp:ResourceControl ID="ResourceControl1" runat="Server" ResourceName="CP_Settings_ManageSiteTerms_Title"></cp:ResourceControl>
</asp:Content>
    ...
    <div class="CommonListArea">
        ...
        <table border=0 cellpadding=0 cellspacing=0 width=100%>
            <tr>
                ...
                <td align=right><div runat=server id="ImportContainer"><CP:ResourceControl runat="server" ResourceName="CP_Settings_ManageSiteTerms_Import_All_From"></CP:ResourceControl> <asp:DropDownList id="ImportAllFromDropDownList" runat="server"><asp:ListItem Value="en-US">English</asp:ListItem></asp:DropDownList>&nbsp;&nbsp;<asp:Button runat="server" id="btnImportAll" Text="Import" /></div></td>
            </tr>
        </table>
        ...
        <table width=100% cellpadding=0 cellspacing=0>
            <tr>
                <td align=right><input runat=server id="btnAddNewTerm" type="button" /></td>
            </tr>
        </table>
    </div>	
</asp:Content>
