<%@ Page language="c#" Codebehind="ManageIP.aspx.cs" AutoEventWireup="false" Inherits="Telligent.Evolution.ControlPanel.Tools.ManageIPAddresses" MasterPageFile="~/ControlPanel/Masters/SetupAdmin.master" %>

<asp:Content ContentPlaceHolderId="DescriptionRegion" runat="server"><cp:resourcecontrol id=RegionTitle runat="Server" resourcename="CP_Tools_ManageIP_Title" /></asp:Content> 
