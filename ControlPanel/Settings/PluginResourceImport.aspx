<%@ Page Title="" Language="C#" MasterPageFile="~/ControlPanel/Masters/Modal.Master" AutoEventWireup="true" CodeBehind="PluginResourceImport.aspx.cs" Inherits="Telligent.Evolution.Web.ControlPanel.Settings.PluginResourceImport" %>

<asp:Content ID="Content5" ContentPlaceHolderID="bcr" runat="server">
	<TEControl:JQuery ID="JQuery2" runat="server" /> 	
