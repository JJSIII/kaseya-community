<%@ Page Language="c#" CodeBehind="FieldGroups.aspx.cs" AutoEventWireup="false" Inherits="Telligent.Evolution.ControlPanel.Membership.FieldGroups" MasterPageFile="~/ControlPanel/Masters/MembershipAdmin.master" %>
...
<asp:Content ContentPlaceHolderID="TaskRegion" runat="Server">
		...
		<ItemTemplate>
			<tr>
				...
				<td class="CommonListCell" nowrap="nowrap">
					<input type="button" onclick="javascript:Telligent_Modal.Open('UserProfileData.aspx?FieldGroupID=<%# Eval("ID") %>', 530, 500, refresh);" value="<%# ResourceManager.GetString("CP_Membership_EditFieldGroup", "ControlPanelResources.xml") %>" />
					&nbsp;
	...
	<p class="PanelSaveButton">
		<input type="button" onclick="javascript:Telligent_Modal.Open('UserProfileData.aspx', 530, 800, refresh);" value='<%= ResourceManager.GetString("CP_Membership_Settings_Profile_FieldGroup_NewFieldGroup", "ControlPanelResources.xml") %>' />
		&nbsp;&nbsp;&nbsp;
	</p>
</asp:Content>
