<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="SiteTermEdit.aspx.cs" Inherits="Telligent.Evolution.ControlPanel.Tools.SiteTermEdit" MasterPageFile="~/ControlPanel/Masters/Modal.master" %>
    ...
    <div class="CommonContentArea">
        <div class="CommonContent">
            <div class="PanelSaveButton">
			    ...
			    <CP:ResourceLinkButton id="btnCancel" runat="server" cssclass="CommonTextButton" resourcename="Cancel" OnClientClick="window.parent.Telligent_Modal.GetWindowOpener(window).Telligent_Modal.Close(); return false;" ></CP:ResourceLinkButton>
		    </div>    
	    </div>
    </div>
</asp:Content>
