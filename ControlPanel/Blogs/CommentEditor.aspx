<%@ Page language="c#" Codebehind="CommentEditor.aspx.cs" AutoEventWireup="false" Inherits="Telligent.Evolution.ControlPanel.Blogs.CommentEditor" MasterPageFile="~/ControlPanel/Masters/Modal.master" %>
...
<asp:Content ContentPlaceHolderId="bcr" runat="server">
	...
	<div class="CommonContentArea">
		<div class="CommonContent">
			...
			<div class="CommonFormField">
				<asp:TextBox runat="server" ID="UserName" Enabled="false" CssClass="ControlPanelTextInput" Width="500" />
			</div>
			<div class="CommonFormField">
