<%@ Page EnableViewState="true" Language="C#" AutoEventWireup="true" MasterPageFile="~/themes/generic/common/modal.Master" %>

<asp:Content ContentPlaceHolderID="content" runat="server">
	<TEControl:Title runat="server" IncludeSiteName="true" ResourceName="Wiki_CopyToWiki" EnableRendering="false" />
				...
				<ul class="field-list">
					...
					<li class="field-item">
						<span class="field-item-input">
							<asp:LinkButton ID="Submit" runat="server" CssClass="internal-link capture-post"><span></span><TEControl:ResourceControl runat="server" ResourceName="Wiki_Capture" /></asp:LinkButton>
			...
			<fieldset class="field-list">
				<ul class="field-list">
					<li class="field-item">
						...
						<span class="field-item-input"><asp:LinkButton runat="server" CssClass="internal-link cancel"  OnClientClick="window.parent.Telligent_Modal.GetWindowOpener(window).Telligent_Modal.Close(); return false;"><span></span><TEControl:ResourceControl runat="server" ResourceName="OK" /></asp:LinkButton></span>
					</li>
				</ul>
			<br/>
		</ContentTemplate>
