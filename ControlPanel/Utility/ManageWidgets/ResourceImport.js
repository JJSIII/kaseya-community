...
(function ($) {
    ...
    var isUploaded = false,
        ...
        setupAction = function (context) {
            ...
            context.elements.saveButton.bind('click', function (e, data) {
                if (!isUploaded) {
                    return false;
                }
            });
