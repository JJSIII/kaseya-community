<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpgradeAttachments.aspx.cs" Inherits="Telligent.Evolution.Web.ControlPanel.Utility.UpgradeAttachments" %>
<html>
	<head>
		<title>Upgrade Attachment Files for Telligent Evolution Platform 6.0</title>
	...
	<body>
		<form runat="server">
			...
			<fieldset class="field-list">
				...
				<div>Use the form below to migrate file attachments for the Telligent Evolution Platform 6.0.</div>
				<ul class="field-list"><%--
					<li class="field-item">
