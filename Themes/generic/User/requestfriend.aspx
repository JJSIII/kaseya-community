...
<asp:Content ContentPlaceHolderID="content" runat="server">
    <script type="text/C#" runat="server">
        ...
        {
            var context = Telligent.Common.Services.Get<IContextService>().GetExecutionContext();
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
            <% if(validateMessage) { %>
                ...
                $('#<%= CSControlUtility.Instance().FindControl(this, "Message").ClientID %>').bind('change', f);
            <% } %>
		});
		// ]]>
	</script>
            ...
            <fieldset class="field-list">
                <ul class="field-list">
	                <li class="field-item">
		                ...
		                <span class="field-item-input"><TEControl:UserData UseAccessingUser="true" Property="DisplayName" runat="server" /> (<TEControl:UserData UseAccessingUser="true" Property="Email" runat="server" />)</span>
	                </li>
	                <li class="field-item">
